...
export const generateOneWrongTypeReport = async ({
    ...
    const typesDeclarations: TypeDeclaration[] = onlyExport
        ...
        : [...sourceFile.getInterfaces(), ...sourceFile.getTypeAliases(), ...sourceFile.getEnums()];
...
export const generateReporter =
    (onError: (errorReport: GeneratedWrongTypeErrorReport) => void, onNotError?: () => void) =>
    /**
     ...
     */
    <T>(reporter: (toValidate: unknown) => GeneratedWrongTypeErrorReport | undefined) =>
    (fromApi: T) => {
        try {
